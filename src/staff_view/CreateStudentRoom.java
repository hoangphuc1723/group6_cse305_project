...
public class CreateStudentRoom extends javax.swing.JFrame {
    ...
    private void createStudentButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createStudentButtonActionPerformed
        ...
        if (!roomName.isBlank()) {
            ...
            this.sendLoginInforToStudentEmail(id, pass);
    ...
    private void checkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkButtonActionPerformed
        ...
        //hall for check room
        List<Hall> hallList = Administrator.getListHall();
    ...
    public void sendLoginInforToStudentEmail(String userName, String pass){
        JOptionPane.showMessageDialog(this, "Username: "+userName + "\n" + "Password: " + pass);
        JOptionPane.showMessageDialog(this, "Username and Password will be sent to student email!");
    }
