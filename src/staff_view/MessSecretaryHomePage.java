...
public class MessSecretaryHomePage extends javax.swing.JFrame {
    ...
    public MessSecretaryHomePage(int hallNumber) {
        ...
        this.secretary.setListFormMess(RestoreDataUtils.restoreFormListData(new File("mess" + hallNumber + ".txt")));
        addDataToTable();
    ...
    public void addRowMessTable(Object[] object) {
        this.model = (DefaultTableModel) messTable.getModel();
        model.addRow(object);
    }
    ...
    private void doubleClickOnTable(Component evt, JTable a) {
        ...
        try {
            ...
            String des = secretary.getListFormMess().get(row).getDescription();
