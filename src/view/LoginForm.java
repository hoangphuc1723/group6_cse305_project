            ...
            switch (sign) {
                case "S" -> {
                    ...
                    if(sec.equalsIgnoreCase("SA")){
                        new MaintenanceSecretaryHomePage(Integer.parseInt(String.valueOf(username.charAt(7)))).setVisible(true);
                    } else {
                ...
                case "M" ->
                    new WardenMaintenance(Integer.parseInt(String.valueOf(username.charAt(6)))).setVisible(true);
                case "A" ->
